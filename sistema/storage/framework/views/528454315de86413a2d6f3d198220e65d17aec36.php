            ...
            <table id="tablaDetalle" class="table table-hover table-condensed table-responsive" style="width:100%">
                ...
                <tbody>
                    <?php $__currentLoopData = $listaNotasdeVenta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><a href="vernotaventa/<?php echo e($item->idNotaVenta); ?>/1/" class="btn btn-xs btn-info" title="Ver Nota Venta"><?php echo e($item->idNotaVenta); ?></a></td>
                            ...
                            <?php endif; ?>
                            <td>
                                <?php if($item->aprobada==1 and Session::get('grupoUsuario')=='C' and Session::get("idPerfil")!=11 ): ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var grupo='<?php echo e(Session::get("grupoUsuario")); ?>';
                ...
                buttons: [
                    {
                        ...
                        action: function ( e, dt, node, config ) {
                            if( uPerfil==11 || grupo!='C' ){
                                ...
                                location.href="<?php echo e(asset('/')); ?>nuevanotaventa";
                            }
                        }
                    },               
                    {
