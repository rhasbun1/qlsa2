...
<div style="padding: 20px">
    <div class="panel panel-default table-responsive">
        ...
        <div class="panel-heading">
            <b>Usuarios</b>
            <span class="badge badge-info pull-right"><?php echo e(count($listaUsuarios)); ?> Usuarios</span>
        </div>
                ...
                <tbody>
                    <?php $__currentLoopData = $listaUsuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($item->usu_correo); ?></td>
                            <td><?php echo e($item->planta); ?></td>
                            <td>
                    ...
                    <div id="divPlantas" style="padding: 5px" class="col-md-12">
                        <div class="list-group">
                            ...
                            <?php $__currentLoopData = $plantas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <input type="checkbox" name="CheckBoxInputName" value="<?php echo e($item->idPlanta); ?>" id="CheckBox<?php echo e($cont); ?>" />
                                <label class="list-group-item" for="CheckBox<?php echo e($cont); ?>"><?php echo e($item->nombre); ?></label>
                                <?php
                                    $cont=$cont+1;
                                ?>                                                        
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
