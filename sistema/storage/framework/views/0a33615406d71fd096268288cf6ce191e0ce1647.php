        ...
        <div class="panel-heading">
            <div class="panel-tab clearfix">
                <ul class="tab-bar">
                    ...
                    <?php if(Session::get('idPerfil')!='9' and Session::get('idPerfil')!='6'): ?> 
                    ...
                    <table id="tablaAprobados" class="table table-condensed">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $pedidos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(   ($item->idEstadoPedido!='1' and $item->idEstadoPedido!='6') and 
                                    ...
                                    <?php endif; ?>  
                                        ...
                                        <td style="width:200px"><?php echo e($item->nombreCliente); ?></td>
                                        <td style="width:200px">
                                            <?php echo e($item->nombreObra); ?>
                                        ...
                                        <?php if( Session::get('idPerfil')=='10' ): ?>
                                            ...
                                            <td style="width:70px"><?php echo e($item->fechaEntrega); ?> <?php echo e($item->horarioEntrega); ?></td>
                                            <td style="width:100px">
                                                <?php echo e($item->prod_nombre); ?>  
                                            </td>                                            
                                            <td style="width:50px"><?php echo e($item->cantidad); ?></td>
                                            <td style="width:50px"><?php echo e($item->u_abre); ?></td>
                                        <?php else: ?>
                                            <td style="width:100px">
                                                <?php echo e($item->prod_nombre); ?> 
                                            </td>
                                            ...
                                            <td style="width:70px"><?php echo e($item->fechaEntrega); ?> <?php echo e($item->horarioEntrega); ?></td>
                                            <td style="width:50px"><?php echo e($item->formaEntrega); ?></td>
                                            <td style="width:120px"><?php echo e($item->fechaCarga); ?> <?php echo e($item->horaCarga); ?> </td>
                                            <td style="width:150px"><?php echo e($item->apellidoConductor); ?> / <?php echo e($item->empresaTransporte); ?></td>
                                        <?php endif; ?>
                                ...
                                <?php $__currentLoopData = $pedidos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if( $item->idEstadoPedido == '1' ): ?>
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><?php echo e(number_format( $item->cantidad, 0, ',', '.' )); ?></td>
                                            <td><?php echo e($item->nombrePlanta); ?></td>
                                            <td><?php echo e($item->formaEntrega); ?></td>
                                            <td><?php echo e($item->fechaEntrega); ?></td>
                                            <td><?php echo e($item->horarioEntrega); ?></td>
                                        </tr>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>              
    ...
    <!-- Modal content-->
        <div class="modal-content">
            ...
            <div id="map" style="height: 400px">
                 <img src="<?php echo e(asset('/')); ?>img/mapa.jpg" border="0" style="width:100%; height:100%">
            </div>
