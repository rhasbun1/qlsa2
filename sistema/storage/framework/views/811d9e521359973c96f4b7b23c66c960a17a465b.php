...
<div style="padding: 10px">
    <div class="panel panel-default table-responsive">
        ...
        <?php echo $__env->make('formularioObra', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script src="<?php echo e(asset('/')); ?>js/app/formularioObra.js"></script>
    <!-- Datatable -->
