	                ...
	                <tbody>
	                    <?php $__currentLoopData = $cargos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                        <tr>
                                ...
                                <td>
                                    <input class="form-control input-sm" value="<?php echo e($item->flete); ?>" onkeypress='return isIntegerKey(event)'>
                                </td>
                                <td>
                                    <input class="form-control input-sm" value="<?php echo e($item->distancia); ?>" onkeypress='return isIntegerKey(event)'>
                                </td>
                                <td>
                                    <input class="form-control input-sm" value="<?php echo e($item->tiempoTraslado); ?>" onkeypress='return isIntegerKey(event)'>
                                </td>
	                            <td style="width:40px">
