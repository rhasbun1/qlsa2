    ...
    <div class="panel panel-default">
        ...
        <div class="padding-md clearfix" style="width:450px"> 
            <table id="tabla" class="table table-hover table-condensed" style="width:450px">
                ...
                <tbody>
                    <?php $__currentLoopData = $ramplas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td style="width:80px"><?php echo e($item->numero); ?></td>
                            <td style="width:300px"><?php echo e($item->patente); ?></td>
                            <td style="width:50px">                           
                                <button class="btn btn-xs btn btn-warning" onclick="editarRampla( <?php echo e($item->numero); ?>, this.parentNode.parentNode.rowIndex )" title="Editar" ><i class="fa fa-edit fa-lg"></i></button>
