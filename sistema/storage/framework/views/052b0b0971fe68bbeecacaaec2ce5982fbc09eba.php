...
<div style="padding: 20px">
    <div class="panel panel-default table-responsive">
		...
		<div style="padding: 20px">
        	<div class="row" style="padding-top: 5px">
                <input id="idEmpresaTransporte" type="hidden" value="<?php echo e($idEmpresaTransporte); ?>">
                ...
                <?php if( Session::get('idPerfil')=='1' or 
            		...
            		<div class="col-sm-3">
            			<input id="nombre" class="form-control input-sm" value="<?php if(isset( $empresa[0]->nombre )): ?> <?php echo e($empresa[0]->nombre); ?> <?php endif; ?>">
            		</div>
            		<div class="col-sm-2">
            			Rut
            		</div>
            		<div class="col-sm-2">
            			<input id="rut" class="form-control input-sm" value="<?php if(isset( $empresa[0]->rut )): ?> <?php echo e($empresa[0]->rut); ?> <?php endif; ?>">
            		</div>        		 		
            	</div>
            	<div class="row" style="padding-top: 5px">
            		<div class="col-sm-2">
            		...
            		<div class="col-sm-3">
            			<input id="email" class="form-control input-sm" value="<?php if(isset( $empresa[0]->email )): ?> <?php echo e($empresa[0]->email); ?> <?php endif; ?>">
            		</div>
            		<div class="col-sm-2">
            			Telefono
            		</div>
            		<div class="col-sm-3">
            			<input id="telefono" class="form-control  input-sm" value="<?php if(isset( $empresa[0]->telefono )): ?> <?php echo e($empresa[0]->telefono); ?> <?php endif; ?>">
            		</div>        		
            	</div>
            	<div class="row" style="padding-top: 5px">
            		<div class="col-sm-2">
            		...
            		<div class="col-sm-3">
            			<input id="nombreContacto" class="form-control input-sm" value="<?php if(isset( $empresa[0]->nombreContacto )): ?> <?php echo e($empresa[0]->nombreContacto); ?> <?php endif; ?>">
            		</div>
            	</div>
            <?php else: ?>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-3">
                        <input id="nombre" class="form-control input-sm" value="<?php if(isset( $empresa[0]->nombre )): ?> <?php echo e($empresa[0]->nombre); ?> <?php endif; ?>" readonly>
                    </div>
                    <div class="col-sm-2">
                        Rut
                    </div>
                    <div class="col-sm-2">
                        <input id="rut" class="form-control input-sm" value="<?php if(isset( $empresa[0]->rut )): ?> <?php echo e($empresa[0]->rut); ?> <?php endif; ?>" readonly>
                    </div>                      
                </div>
                <div class="row" style="padding-top: 5px">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-3">
                        <input id="email" class="form-control input-sm" value="<?php if(isset( $empresa[0]->email )): ?> <?php echo e($empresa[0]->email); ?> <?php endif; ?>" readonly>
                    </div>
                    <div class="col-sm-2">
                        Telefono
                    </div>
                    <div class="col-sm-3">
                        <input id="telefono" class="form-control  input-sm" value="<?php if(isset( $empresa[0]->telefono )): ?> <?php echo e($empresa[0]->telefono); ?> <?php endif; ?>" readonly>
                    </div>              
                </div>
                <div class="row" style="padding-top: 5px">
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-3">
                        <input id="nombreContacto" class="form-control input-sm" value="<?php if(isset( $empresa[0]->nombreContacto )): ?> <?php echo e($empresa[0]->nombreContacto); ?> <?php endif; ?>" readonly>
                    </div>
                </div>            
            <?php endif; ?>           	
        </div>          	        	
    ...
    <div id="divCamiones" class="panel panel-default table-responsive" style="display: <?php if( $idEmpresaTransporte=="0"): ?> none <?php else: ?> block <?php endif; ?>">
        <div class="panel-heading">
            <b>Camiones</b>
        </div>
        <div style="padding: 20px">
            ...
            <table id="tablaCamiones" class="table table-hover table-condensed" style="width: 600px">
                ...
                <tbody>
                    <?php $__currentLoopData = $camiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <tr>
                           <td style='display:none'> <?php echo e($item->idCamion); ?> </td>
                           <td> <?php echo e($item->patente); ?> </td>
                           <td> <?php echo e($item->patenteRampla); ?> </td>
                           <td> 
                           ...
                           <td>
                                <?php if( Session::get('idPerfil')=='1' or 
                                    ...
                                    Session::get('idPerfil')=='5' or 
                                    Session::get('idPerfil')=='7'): ?>                            
                               <button onclick="editarCamion(<?php echo e($item->idCamion); ?>, this.parentNode.parentNode.rowIndex);" class="btn btn-warning btn-xs" title="Editar"><i class="fa fa-edit fa-lg"></i></button>
                               <button class="btn btn-xs btn btn-danger" title="Eliminar" onclick="eliminarCamion(<?php echo e($item->idCamion); ?>, this.parentNode.parentNode.rowIndex)"><i class="fa fa-trash-o fa-lg"></i></button>
                               <?php endif; ?>
                           </td>
                       </tr>
    ...
    <div id="divConductores" class="panel panel-default table-responsive" style="display: <?php if( $idEmpresaTransporte=="0"): ?> none <?php else: ?> block <?php endif; ?>">
        <div class="panel-heading">
            <b>Conductores</b>
        </div>
        <div style="padding: 20px">
            ...
            <table id="tablaConductores" class="table table-hover table-condensed table-responsive">
                ...
                <tbody>
                    <?php $__currentLoopData = $conductores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                       <tr>
                           <td style='display:none'> <?php echo e($item->idConductor); ?> </td>
                           <td> <?php echo e($item->nombre); ?> </td>
                           <td> <?php echo e($item->apellidoPaterno); ?> </td>
                           <td> <?php echo e($item->apellidoMaterno); ?> </td>
                           ...
                           <td>
                                <?php if( Session::get('idPerfil')=='1' or 
                                    ...
                                    Session::get('idPerfil')=='5' or 
                                    Session::get('idPerfil')=='7'): ?>                            
                               <button onclick="editarConductor(<?php echo e($item->idConductor); ?>, this.parentNode.parentNode.rowIndex);" class="btn btn-warning btn-xs" title="Editar"><i class="fa fa-edit fa-lg"></i></button>
                               <button class="btn btn-xs btn btn-danger" title="Eliminar" onclick="eliminarConductor(<?php echo e($item->idConductor); ?>, this.parentNode.parentNode.rowIndex)"><i class="fa fa-trash-o fa-lg"></i></button>
                               <?php endif; ?>
                           </td>
                       </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
    ...
    <div style="padding-top:18px; padding-bottom: 20px;padding-left: 20px">
        <a href="<?php echo e(asset('/')); ?>listaEmpresasTransporte" class="btn btn-sm btn-warning" style="width:80px">Atrás</a>
    </div>   
</div>
