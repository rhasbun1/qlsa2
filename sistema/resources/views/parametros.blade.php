		...
		<div style="padding:20px">
			<div class="row" style="padding:3px">
				...
				<div class="col-md-2 col-lg-1">
					<input class="form-control input-sm" id="correlativoGuias" value="{{ $param[0]->numeroGuia }}">
				</div>
			</div>
			<div class="row" style="padding:3px">
				<div class="col-md-2">
				...
				<div class="col-md-1">
					<input class="form-control input-sm" id="iva" value="{{ $param[0]->iva }}">
				</div>
			</div>		
			<div class="row" style="padding:3px">
				<div class="col-md-2">
				...
				<div class="col-md-1">
					<input class="form-control input-sm" id="cmgttn" value="{{ $param[0]->carga_max_granel_tte_normal }}">
				</div>
			</div>
			<div class="row" style="padding:3px">
				<div class="col-md-2">
				...
				<div class="col-md-1">
					<input class="form-control input-sm" id="cmgttm1" value="{{ $param[0]->carga_max_granel_tte_mixto_1 }}">
				</div>
			</div>
			<div class="row" style="padding:3px">
				<div class="col-md-2">
				...
				<div class="col-md-1">
					<input class="form-control input-sm" id="cmgttm2" value="{{ $param[0]->carga_max_granel_tte_mixto_2 }}">
				</div>
			</div>			
			<br>
			...
			<div class="row" style="padding:3px">
				...
				<div class="col-md-2">
					<input class="form-control input-sm" id="antiguedadDias" value="{{ $param[0]->antiguedad_dias }}">
				</div>
			</div>
			<div class="row" style="padding:3px">
				<div class="col-md-3">
