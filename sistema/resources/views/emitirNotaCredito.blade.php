    <div id="divEmitirNotaCredito" style="display: none">
      	<div>
      		<h4>Emitir Nota de Crédito</h4>
      	</div>
		...
		<div>
			...
			<button class="btn btn-sm btn-info" onclick="abrirModalSubirNotaCredito();">Subir Nota de Crédito</button>
			<button class="btn btn-sm btn-warning" onclick="cerrarEmitirNotaCredito();" style="width: 100px">Atrás</button>
		</div>
    </div>

<div id="mdDescartarNotaCredito" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
...
<div id="mdSubirNotaCredito" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-md">
    <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h5><b>Subir Nota de Crédito en PDF</b></h5>
            </div>
            <div class="modal-body">
            	<div class="row">
            		<div class="col-md-4">
            ...
            <div class="col-md-offset-8" style="padding-top: 20px; padding-bottom: 20px">
            	<button type="button" class="btn btn-danger data-dismiss=modal btn-sm" style="width: 80px">Aceptar</button>
               	<button type="button" class="btn btn-danger data-dismiss=modal btn-sm" onclick="cerrarModalSubirNotaCredito();" style="width: 80px">Volver</button>
            </div>            
        </div>
    </div>
</div>